...
tar -cz -C "$DIR/pb_hooks" notify.pb.js join.pb.js packs.pb.js purchases.pb.js cleanup.pb.js members.pb.js rewards.pb.js _notify_helper.js _members_helper.js \
